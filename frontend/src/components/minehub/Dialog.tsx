  ...
  return createPortal(
    <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4
      ...
      <div ref={panel} role="dialog" aria-modal="true" aria-label={title}
        className="w-[min(520px,100%)] bg-bg-base rounded-2xl shadow-xl border border-border-light
                   overflow-hidden">
        ...
        <div className="px-5 py-3.5 bg-bg-light border-t border-border-light flex justify-end gap-2">
