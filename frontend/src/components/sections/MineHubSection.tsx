"use client";
/**
 * MineHub Platform — Equipment Registry. Superadmin only.
 *
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-semibold text-[15px] tracking-wide">
              MineHub Platform · Equipment Registry
            </h1>
            <p className="text-white/55 text-[12px] mt-0.5">
              One identity per machine. Register it once here, and every system —
              telematics, handover, weighbridge, RFID — points at the same record.
            </p>
          </div>
        </div>
      </div>
